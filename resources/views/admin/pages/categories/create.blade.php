            ...
            <div class="card">
                ...
                <div class="card-body add-post">
                    @if ($errors->any())
                        ...
                        @endforeach
                    @endif
                    <form class="needs-validation " novalidate action="{{ route('categories.store') }}" method="POST" enctype="multipart/form-data" class="row needs-validation"   novalidate="">
                        @csrf
                        <div class="row my-3">
                            <div class="col-12">
                                <label  for="name">Category Name</label>
                                <input name="name" placeholder="Enter Your Name"  class="form-control" for="name">
                            </div>
