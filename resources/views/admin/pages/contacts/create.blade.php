            ...
            <div class="card">
                ...
                <div class="card-body add-post">
                    @if ($errors->any())
                        ...
                        @endforeach
                    @endif
                    <form class="needs-validation " novalidate action="{{ route('contacts.store') }}" method="POST" enctype="multipart/form-data" class="row needs-validation"   novalidate="">
                        @csrf
                        <div class="row mb-2">
                            <div class="col-12">
                        ...
                        <div class="row mb-2">
                            <div class="col-12">
                                <label for="education">Message Details:</label>
                        ...
                        <div class="btn-showcase">
                            ...
                            <a href="{{ route('contacts.index') }}" type="submit" class="btn btn-info">Back</a>
                        </div>
                        </div>
                    </form>
                </div>
